...
export const register = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const newUser = await prisma.user.create({
      data: {
        ...
        providerId: `local_${Date.now()}_${Math.random()
          .toString(36)
          .substr(2, 9)}`,
        // TODO: [PRODUCTION] Change to false and enable email verification
        // For development/testing, users are auto-verified
        isVerified: true, // DEV MODE: Auto-verify users
      },
    });

    // TODO: [PRODUCTION] Re-enable email verification
    // For development/testing, skip sending verification email
    /*
    try {
    ...
    */
    logger.info(`DEV MODE: User ${newUser.email} auto-verified, skipping email`);
    ...
    res
      ...
      .json({
        ...
        token: token,
        // TODO: [PRODUCTION] Set to true when email verification is enabled
        requiresVerification: false // DEV MODE: No verification required
      });
  } catch (err) {
...
export const login = async (req: Request, res: Response) => {
  ...
  try {
    ...
    // TODO: [PRODUCTION] Re-enable email verification check
