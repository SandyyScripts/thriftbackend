...
export const sendResetEmail = async (to: string, code: string) => {
  ...
  if (!process.env.EMAIL_USER || !process.env.EMAIL_PASS) {
    ...
    try {
      ...
      const mailOptions = {
        from: `"Thrift Store" <${testAccount.user}>`,
        to,
  ...
  try {
    ...
    const mailOptions = {
      from: "Thrift Store <no-reply@thriftstore.com>",
      to,
      subject: "Password Reset Code",
      html: `
        <h2>Password Reset Code</h2>
...
export const sendVerificationEmail = async (
  ...
  if (!process.env.EMAIL_USER || !process.env.EMAIL_PASS) {
    ...
    try {
      ...
      const verificationUrl = `${process.env.CLIENT_URL || "https://licorice4good.com"
        ...
        html: `
          <div style="max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif;">
            <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
              <h1 style="color: white; margin: 0; font-size: 28px;">Welcome to Thrift Store!</h1>
            ...
            <div style="background: #f8f9fa; padding: 30px; border-radius: 0 0 10px 10px;">
              ...
              <p style="font-size: 16px; color: #333; margin-bottom: 20px;">
                Thank you for registering with Thrift Store! To complete your account setup, please verify your email address.
              </p>
